...
defineProps({
  isAuthenticated: Boolean, // Explicitly define the prop type
});
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                ...
                <div class="flex">
                    ...
                    <div v-if="!isAuthenticated" class="ml-2 flex items-center md:ml-4">
                        <router-link
                            to="/register"
                            type="button"
                    ...
                    <div v-else class="flex items-center">
                        <!-- Display user profile or logout button -->
                        <button
                            type="button"
                            class="rounded px-3 py-1 font-semibold text-slate-700 bg-accent hover:text-slate-900"
                            @click="logout"
